...
#define NB_CHAR 254   // taille maximale d'une chaîne lue sur stdin
#define NB_COFFRES 10 // taille initiale du tableau de coffres
...
int main (int argc, char *argv[]) {
    ...
    while (fgets(ligne, NB_CHAR+2, stdin) != NULL) {
        ...
        if (!contains) { //si la table ne contient pas le coffre
            ...
            strcat(coffres[i], ligne+TAILLE_ID);  // arithmétique des pointeurs
        }
    }
