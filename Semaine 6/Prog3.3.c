//gcc -std=c11 -pedantic -Werror -Wall -Wvla -Wno-unused-variable -o testProg3.3_indices.c prog3.3_indices.c
...
// en introduisant les donn̩es

// Liens vers vid̩o explicative: https://youtu.be/3se3fusg7zc
